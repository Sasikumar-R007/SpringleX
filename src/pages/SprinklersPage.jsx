...
const SprinklersPage = () => {
  ...
  // Filter sprinklers for this specific land
  const landSprinklers = sprinklers.filter(sprinkler => sprinkler.landId === parseInt(landId));

  // Translations
  const t = {
    en: {
      backToLands: 'Back to Lands',
      landTitle: `Land ${landId} - Smart Sprinklers`,
      sprinklers: 'Smart Sprinklers',
    ...
    ta: {
      ...
      landTitle: `நிலம் ${landId} - ஸ்மார்ட் ஸ்பிரிங்க்லர்கள்`,
      sprinklers: 'ஸ்மார்ட் ஸ்பிரிங்க்லர்கள்',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <button
            ...
            className="flex items-center text-sprinkle-green hover:text-green-600 mb-4 transition-colors"
          >
          ...
          <div className="flex items-center mb-4">
            <MapPin size={24} className="text-sprinkle-green mr-2" />
            <h1 className="text-3xl font-bold text-sprinkle-dark">
              {getText('landTitle')}
            </h1>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium">{landSprinklers.length}</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        {landSprinklers.length > 0 ? (
          ...
          >
            {landSprinklers.map((sprinkler, index) => (
              <motion.div
                key={sprinkler.id}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Droplet size={48} className="text-gray-400 mx-auto mb-4" />
            <p className="text-gray-600 text-lg">{getText('noSprinklers')}</p>
          </motion.div>
        )}
